...
public class ExampleBSServiceImplTest {
    ...
    public void exceptionTest() {
        ...
        doThrow(new HttpStatusException(HttpStatus.NOT_FOUND, "Category not Found.")).when(categoryRepository)
                .findById(1L);

        assertThrows(HttpStatusException.class, () -> exampleDBServiceImpl.getCategory(1L));
